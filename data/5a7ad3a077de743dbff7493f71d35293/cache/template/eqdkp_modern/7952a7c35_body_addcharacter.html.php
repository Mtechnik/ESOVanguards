...
echo '
 ...
 var mainid = ' . ((isset($this->_data['.'][0]['MAIN_ID'])) ? $this->_data['.'][0]['MAIN_ID'] : '') . ';
 var others = ' . ((isset($this->_data['.'][0]['COUNT_OTHER_MEMBERS'])) ? $this->_data['.'][0]['COUNT_OTHER_MEMBERS'] : '') . ';
 
 function check_form(){
	var selected_main = $(\'#main_id\').val();
	if (selected_main == mainid || others < 1) {
		return true;
	}
 ...
 function handle_assoc_members() {
	if ($(\'#associated_members\').prop("checked")){
		cbvalue = 1;
	} else {
		cbvalue = 0;
	}
	$(\'#assoc_members\').val(cbvalue);
 }
 
</script>-->
<form method="post" action="' . ((isset($this->_data['.'][0]['ACTION'])) ? $this->_data['.'][0]['ACTION'] : '') . '" name="' . ((isset($this->_data['.'][0]['FORM_ID'])) ? $this->_data['.'][0]['FORM_ID'] : '') . '" id="' . ((isset($this->_data['.'][0]['FORM_ID'])) ? $this->_data['.'][0]['FORM_ID'] : '') . '" class="fv_checkit">
<input type="hidden" name="adminmode" size="2" value="' . ((isset($this->_data['.'][0]['ADMINMODE'])) ? $this->_data['.'][0]['ADMINMODE'] : '') . '"/>
...
// END tabs
echo '
		<li><a href=\'#fragment-notes\'><span>' . ((isset($this->_data['.'][0]['L_uc_tab_notes'])) ? $this->_data['.'][0]['L_uc_tab_notes'] : (($this->lang('uc_tab_notes')) ? $this->lang('uc_tab_notes') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'uc_tab_notes'))) . '         }')) . '</span></a></li>
		';// IF ADMINMODE
if ($this->_data['.'][0]['ADMINMODE']) { 
echo '
		<li><a href=\'#fragment-history\'><span>' . ((isset($this->_data['.'][0]['L_uc_transfer_history'])) ? $this->_data['.'][0]['L_uc_transfer_history'] : (($this->lang('uc_transfer_history')) ? $this->lang('uc_transfer_history') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'uc_transfer_history'))) . '         }')) . '</span></a></li>
		';// ENDIF
}
echo '
	</ul>

	' . ((isset($this->_data['.'][0]['HIDDEN'])) ? $this->_data['.'][0]['HIDDEN'] : '') . '
	';// BEGIN tabs
$_tabs_count = (isset($this->_data['tabs.'])) ?  sizeof($this->_data['tabs.']) : 0;
if ($_tabs_count) {
for ($_tabs_i = 0; $_tabs_i < $_tabs_count; $_tabs_i++)
...
echo '
	<div id="fragment-' . ((isset($this->_data['tabs.'][$_tabs_i]['ID'])) ? $this->_data['tabs.'][$_tabs_i]['ID'] : '') . '">
		<fieldset class="settings">
			';// BEGIN fields
$_fields_count = (isset($this->_data['tabs.'][$_tabs_i]['fields.'])) ? sizeof($this->_data['tabs.'][$_tabs_i]['fields.']) : 0;
if ($_fields_count) {
for ($_fields_i = 0; $_fields_i < $_fields_count; $_fields_i++)
{
echo '
			<dl>
				<dt><label>' . ((isset($this->_data['tabs.'][$_tabs_i]['fields.'][$_fields_i]['NAME'])) ? $this->_data['tabs.'][$_tabs_i]['fields.'][$_fields_i]['NAME'] : '') . '</label><br /><span>' . ((isset($this->_data['tabs.'][$_tabs_i]['fields.'][$_fields_i]['HELP'])) ? $this->_data['tabs.'][$_tabs_i]['fields.'][$_fields_i]['HELP'] : '') . '</span></dt>
				<dd>' . ((isset($this->_data['tabs.'][$_tabs_i]['fields.'][$_fields_i]['FIELD'])) ? $this->_data['tabs.'][$_tabs_i]['fields.'][$_fields_i]['FIELD'] : '') . '</dd>
			</dl>
			';}}
// END fields
echo '
...
echo '
	...
	<div id="fragment-notes">
		<fieldset class="settings mediumsettings">
			<dl>
				<dt><label>' . ((isset($this->_data['.'][0]['L_uc_notes'])) ? $this->_data['.'][0]['L_uc_notes'] : (($this->lang('uc_notes')) ? $this->lang('uc_notes') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'uc_notes'))) . '         }')) . '</label><br /><span>' . ((isset($this->_data['.'][0]['L_uc_notes_help'])) ? $this->_data['.'][0]['L_uc_notes_help'] : (($this->lang('uc_notes_help')) ? $this->lang('uc_notes_help') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'uc_notes_help'))) . '         }')) . '</span></dt>
				<dd><textarea name="notes" class="input" rows="12" style="width: 95%">' . ((isset($this->_data['.'][0]['NOTES'])) ? $this->_data['.'][0]['NOTES'] : '') . '</textarea></dd>
			</dl>
		</fieldset>
	</div>
	';// IF ADMINMODE
...
echo '
	<div id="fragment-history">
		<fieldset class="settings">
			<dl>
				<dt><label>' . ((isset($this->_data['.'][0]['L_uc_transfer_history_receiver'])) ? $this->_data['.'][0]['L_uc_transfer_history_receiver'] : (($this->lang('uc_transfer_history_receiver')) ? $this->lang('uc_transfer_history_receiver') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'uc_transfer_history_receiver'))) . '         }')) . '</label><br /><span>' . ((isset($this->_data['.'][0]['L_uc_transfer_history_receiver_note'])) ? $this->_data['.'][0]['L_uc_transfer_history_receiver_note'] : (($this->lang('uc_transfer_history_receiver_note')) ? $this->lang('uc_transfer_history_receiver_note') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'uc_transfer_history_receiver_note'))) . '         }')) . '</span></dt>
				<dd>' . ((isset($this->_data['.'][0]['DD_HISTORY_RECEIVER'])) ? $this->_data['.'][0]['DD_HISTORY_RECEIVER'] : '') . '</dd>
			</dl>
		</fieldset>
	</div>
	';// ENDIF
...
<br />
	...
	';// IF U_IS_EDIT
if ($this->_data['.'][0]['U_IS_EDIT']) { 
echo '
	<button class="mainoption" type="submit" name="edit" id="editButton"><i class="fa fa-check"></i>' . ((isset($this->_data['.'][0]['L_uc_save_char'])) ? $this->_data['.'][0]['L_uc_save_char'] : (($this->lang('uc_save_char')) ? $this->lang('uc_save_char') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'uc_save_char'))) . '         }')) . '</button>
	';// ELSE
} else {
echo '
	<button class="mainoption" type="submit" name="add"><i class="fa fa-check"></i>' . ((isset($this->_data['.'][0]['L_uc_add_char'])) ? $this->_data['.'][0]['L_uc_add_char'] : (($this->lang('uc_add_char')) ? $this->lang('uc_add_char') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'uc_add_char'))) . '         }')) . '</button>
	';// ENDIF
}
echo '
	<input type="hidden" name="assoc_members" id="assoc_members" value="0" />
