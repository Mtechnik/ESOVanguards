...
<div class="breadcrumb-container">
	<ul class="breamcrumb">
		...
		<li class="current"><a>' . ((isset($this->_data['.'][0]['L_raidlogimport'])) ? $this->_data['.'][0]['L_raidlogimport'] : (($this->lang('raidlogimport')) ? $this->lang('raidlogimport') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'raidlogimport'))) . '         }')) . ': ' . ((isset($this->_data['.'][0]['L_settings'])) ? $this->_data['.'][0]['L_settings'] : (($this->lang('settings')) ? $this->lang('settings') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'settings'))) . '         }')) . '</a></li>
	</ul>
	<div class="clear"></div>
</div>
';// ENDIF
...
echo '
	<div class="contentHeader">
		<h1 class="contentTitle">' . ((isset($this->_data['.'][0]['L_settings'])) ? $this->_data['.'][0]['L_settings'] : (($this->lang('settings')) ? $this->lang('settings') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'settings'))) . '         }')) . '</h1>
	</div>

';// IF S_GERMAN
if ($this->_data['.'][0]['S_GERMAN']) { 
echo '
<div class="infobox infobox-large infobox-blue clearfix">
	<i class="fa fa-info-circle fa-4x pull-left"></i> ' . ((isset($this->_data['.'][0]['L_rli_manual'])) ? $this->_data['.'][0]['L_rli_manual'] : (($this->lang('rli_manual')) ? $this->lang('rli_manual') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'rli_manual'))) . '         }')) . '
</div>
<br />
';// ENDIF
}
echo '
<form action="' . ((isset($this->_data['.'][0]['ACTION'])) ? $this->_data['.'][0]['ACTION'] : '') . '" method="post">
' . ((isset($this->_data['.'][0]['TAB_JS'])) ? $this->_data['.'][0]['TAB_JS'] : '') . '
<div id="rli_config"><ul>
';// BEGIN holder
$_holder_count = (isset($this->_data['holder.'])) ?  sizeof($this->_data['holder.']) : 0;
if ($_holder_count) {
for ($_holder_i = 0; $_holder_i < $_holder_count; $_holder_i++)
{
echo '
	<li><a href="#rli_config-' . ((isset($this->_data['holder.'][$_holder_i]['NUM'])) ? $this->_data['holder.'][$_holder_i]['NUM'] : '') . '"><span>' . ((isset($this->_data['holder.'][$_holder_i]['TITLE'])) ? $this->_data['holder.'][$_holder_i]['TITLE'] : '') . '</span></a></li>
';}}
// END holder
echo '
</ul>
...
{
echo '
  <div id="rli_config-' . ((isset($this->_data['holder.'][$_holder_i]['NUM'])) ? $this->_data['holder.'][$_holder_i]['NUM'] : '') . '">
	<fieldset class="settings">
		<legend>' . ((isset($this->_data['holder.'][$_holder_i]['TITLE'])) ? $this->_data['holder.'][$_holder_i]['TITLE'] : '') . '</legend>
		';// BEGIN config
$_config_count = (isset($this->_data['holder.'][$_holder_i]['config.'])) ? sizeof($this->_data['holder.'][$_holder_i]['config.']) : 0;
if ($_config_count) {
...
echo '
		<dl>
			<dt>
				<label>' . ((isset($this->_data['holder.'][$_holder_i]['config.'][$_config_i]['NAME'])) ? $this->_data['holder.'][$_holder_i]['config.'][$_config_i]['NAME'] : '') . '</label><br><span>' . ((isset($this->_data['holder.'][$_holder_i]['config.'][$_config_i]['HELP'])) ? $this->_data['holder.'][$_holder_i]['config.'][$_config_i]['HELP'] : '') . '</span>
			</dt>
			<dd>' . ((isset($this->_data['holder.'][$_holder_i]['config.'][$_config_i]['VALUE'])) ? $this->_data['holder.'][$_holder_i]['config.'][$_config_i]['VALUE'] : '') . '</dd>
		</dl>
		';}}
// END config
echo '
...
<div align=\'center\'>
	<button  name="upd" type="submit" class="mainoption" id="save"><i class="fa fa-check"></i>' . ((isset($this->_data['.'][0]['L_save'])) ? $this->_data['.'][0]['L_save'] : (($this->lang('save')) ? $this->lang('save') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'save'))) . '         }')) . '</button>
	<button type="reset" name="reset" class="liteoption"><i class="fa fa-trash-o"></i>' . ((isset($this->_data['.'][0]['L_reset'])) ? $this->_data['.'][0]['L_reset'] : (($this->lang('reset')) ? $this->lang('reset') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'reset'))) . '         }')) . '</button>
</div>
