...
<div class="breadcrumb-container">
	<ul class="breamcrumb">
		...
		' . ((isset($this->_data['.'][0]['BREADCRUMB'])) ? $this->_data['.'][0]['BREADCRUMB'] : '') . '
	</ul>
	<div class="clear"></div>
</div>
';// ENDIF
...
echo '
<section data-article-id="' . ((isset($this->_data['.'][0]['ARTICLE_ID'])) ? $this->_data['.'][0]['ARTICLE_ID'] : '') . '" data-article-category-id="' . ((isset($this->_data['.'][0]['ARTICLE_REAL_CATEGORY'])) ? $this->_data['.'][0]['ARTICLE_REAL_CATEGORY'] : '') . '" class="article_detail_container ';// IF S_FEATURED
if ($this->_data['.'][0]['S_FEATURED']) { 
echo 'featured';// ENDIF
}
echo '">
	';// IF not S_HIDE_HEADER
if (! $this->_data['.'][0]['S_HIDE_HEADER']) { 
echo '
	<nav>
		';// IF S_PREV_ARTICLE
if ($this->_data['.'][0]['S_PREV_ARTICLE']) { 
echo '
		<a href="' . ((isset($this->_data['.'][0]['U_PREV_ARTICLE'])) ? $this->_data['.'][0]['U_PREV_ARTICLE'] : '') . '" title="' . ((isset($this->_data['.'][0]['PREV_TITLE'])) ? $this->_data['.'][0]['PREV_TITLE'] : '') . '"><i class="fa fa-chevron-left"></i> ' . ((isset($this->_data['.'][0]['PREV_TITLE'])) ? $this->_data['.'][0]['PREV_TITLE'] : '') . '</a>
		';// ENDIF
}
// IF S_NEXT_ARTICLE
if ($this->_data['.'][0]['S_NEXT_ARTICLE']) { 
echo '
		<a href="' . ((isset($this->_data['.'][0]['U_NEXT_ARTICLE'])) ? $this->_data['.'][0]['U_NEXT_ARTICLE'] : '') . '" title="' . ((isset($this->_data['.'][0]['NEXT_TITLE'])) ? $this->_data['.'][0]['NEXT_TITLE'] : '') . '" class="floatRight">' . ((isset($this->_data['.'][0]['NEXT_TITLE'])) ? $this->_data['.'][0]['NEXT_TITLE'] : '') . ' <i class="fa fa-chevron-right"></i></a>
		';// ENDIF
}
echo '
		<div class="clear"></div>
...
if (! $this->_data['.'][0]['ARTICLE_PUBLISHED']) { 
echo '
...
echo '
			...
			<span class="';// IF S_INLINE_EDIT
if ($this->_data['.'][0]['S_INLINE_EDIT']) { 
echo 'headline_inlineedit';// ENDIF
}
echo '">' . ((isset($this->_data['.'][0]['ARTICLE_TITLE'])) ? $this->_data['.'][0]['ARTICLE_TITLE'] : '') . '</span>
				';// IF S_TOOLBAR
if ($this->_data['.'][0]['S_TOOLBAR']) { 
echo ' 
				<div class="floatRight">
					<div class="toolbar-button">
						<span class="' . ((isset($this->_data['.'][0]['ARTICLE_TOOLBAR'])) ? $this->_data['.'][0]['ARTICLE_TOOLBAR'] : '') . ' toolbar"><i class="fa fa-cog"></i></span>
					</div>
				</div>
				';// ENDIF
}
echo '
				<div class="floatRight">
					<a href="' . ((isset($this->_data['.'][0]['PERMALINK'])) ? $this->_data['.'][0]['PERMALINK'] : '') . '" title="' . ((isset($this->_data['.'][0]['L_permalink'])) ? $this->_data['.'][0]['L_permalink'] : (($this->lang('permalink')) ? $this->lang('permalink') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'permalink'))) . '         }')) . '"><i class="fa fa-link"></i></a>
				</div>
			</h1>
		</div>
		<div class="news_author">
			<div class="floatLeft">
				<i class="fa fa-calendar-o"></i> ' . ((isset($this->_data['.'][0]['ARTICLE_TIMETAG'])) ? $this->_data['.'][0]['ARTICLE_TIMETAG'] : '') . ' &bull; <i class="fa fa-user"></i> ' . ((isset($this->_data['.'][0]['ARTICLE_AUTHOR'])) ? $this->_data['.'][0]['ARTICLE_AUTHOR'] : '') . ' ';// IF S_COMMENTS
if ($this->_data['.'][0]['S_COMMENTS']) { 
echo ' &bull; <a href="#comments"><i class="fa fa-comments"></i>' . ((isset($this->_data['.'][0]['COMMENTS_COUNTER'])) ? $this->_data['.'][0]['COMMENTS_COUNTER'] : '') . '</a>';// ENDIF
}
echo '
			</div>
			<div class="news_social floatRight">
				' . ((isset($this->_data['.'][0]['ARTICLE_SOCIAL_BUTTONS'])) ? $this->_data['.'][0]['ARTICLE_SOCIAL_BUTTONS'] : '') . '
			</div>
			<div class="clear"></div>
		</div>
	</header>
...
// IF S_PAGINATION
if ($this->_data['.'][0]['S_PAGINATION']) { 
echo '
	<aside class="articleSitemap">
		<ul>
		';// BEGIN articlesitemap_row
$_articlesitemap_row_count = (isset($this->_data['articlesitemap_row.'])) ?  sizeof($this->_data['articlesitemap_row.']) : 0;
if ($_articlesitemap_row_count) {
for ($_articlesitemap_row_i = 0; $_articlesitemap_row_i < $_articlesitemap_row_count; $_articlesitemap_row_i++)
{
echo '
		<li ';// IF articlesitemap_row.ACTIVE
if ($this->_data['articlesitemap_row.'][$_articlesitemap_row_i]['ACTIVE']) { 
echo 'class="active"';// ENDIF
}
echo '>' . ((isset($this->_data['articlesitemap_row.'][$_articlesitemap_row_i]['LINK'])) ? $this->_data['articlesitemap_row.'][$_articlesitemap_row_i]['LINK'] : '') . '</li>
		';}}
// END articlesitemap_row
echo '
		</ul>
	</aside>
	';// ENDIF
...
echo '
	<article class="article_content ';// IF S_INLINE_EDIT
if ($this->_data['.'][0]['S_INLINE_EDIT']) { 
echo 'article-inlineedit';// ENDIF
}
echo '">
		';// IF not ARTICLE_PUBLISHED
if (! $this->_data['.'][0]['ARTICLE_PUBLISHED']) { 
echo '
		<div class="infobox infobox-large infobox-red clearfix">
			<i class="fa fa-eye-slash fa-lg"></i> ' . ((isset($this->_data['.'][0]['L_article_unpublished_note'])) ? $this->_data['.'][0]['L_article_unpublished_note'] : (($this->lang('article_unpublished_note')) ? $this->lang('article_unpublished_note') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'article_unpublished_note'))) . '         }')) . '
		</div>
		';// ENDIF
}
echo $this->pre_compile('ARTICLE_CONTENT');
echo '
	</article>
	<div class="clear"></div>
	' . ((isset($this->_data['.'][0]['PAGINATION'])) ? $this->_data['.'][0]['PAGINATION'] : '') . '

	<footer class="tags-container">
		';// IF S_TAGS
if ($this->_data['.'][0]['S_TAGS']) { 
echo '
		 <ul class="tags">
			';// BEGIN tag_row
$_tag_row_count = (isset($this->_data['tag_row.'])) ?  sizeof($this->_data['tag_row.']) : 0;
if ($_tag_row_count) {
for ($_tag_row_i = 0; $_tag_row_i < $_tag_row_count; $_tag_row_i++)
{
echo '
			<li><a href="' . ((isset($this->_data['tag_row.'][$_tag_row_i]['U_TAG'])) ? $this->_data['tag_row.'][$_tag_row_i]['U_TAG'] : '') . '">' . ((isset($this->_data['tag_row.'][$_tag_row_i]['TAG'])) ? $this->_data['tag_row.'][$_tag_row_i]['TAG'] : '') . '</a></li>
			';}}
// END tag_row
echo '
		</ul>
...
echo '
		<div class="';// IF S_TAGS
if ($this->_data['.'][0]['S_TAGS']) { 
echo 'floatRight';// ENDIF
}
echo '">' . ((isset($this->_data['.'][0]['ARTICLE_RATING'])) ? $this->_data['.'][0]['ARTICLE_RATING'] : '') . '</div>
		<div class="clear"></div>
	</footer>
	<div class="contentDivider"></div>

	<span id="comments"></span>
	' . ((isset($this->_data['.'][0]['COMMENTS'])) ? $this->_data['.'][0]['COMMENTS'] : '') . '
