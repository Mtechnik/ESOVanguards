...
echo '
<div class="infobox infobox-large infobox-' . ((isset($this->_data['.'][0]['MSG_CLASS'])) ? $this->_data['.'][0]['MSG_CLASS'] : '') . ' clearfix">
	<i class="fa ' . ((isset($this->_data['.'][0]['MSG_ICON'])) ? $this->_data['.'][0]['MSG_ICON'] : '') . ' fa-4x pull-left"></i> <span class="bold">' . ((isset($this->_data['.'][0]['MSG_TITLE'])) ? $this->_data['.'][0]['MSG_TITLE'] : '') . '</span><br />' . ((isset($this->_data['.'][0]['MSG_TEXT'])) ? $this->_data['.'][0]['MSG_TEXT'] : '') . '</span>
</div>
...
echo '
	<div class="contentHeader">
		<h1 class="contentTitle">';// IF MSG_TITLE == ""
if ($this->_data['.'][0]['MSG_TITLE'] == "") { 
echo '' . ((isset($this->_data['.'][0]['L_error'])) ? $this->_data['.'][0]['L_error'] : (($this->lang('error')) ? $this->lang('error') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'error'))) . '         }')) . '';// ELSE
} else {
echo '' . ((isset($this->_data['.'][0]['MSG_TITLE'])) ? $this->_data['.'][0]['MSG_TITLE'] : '') . '';// ENDIF
}
echo '</h1>
	</div>
...
echo '' . ((isset($this->_data['.'][0]['BU_FORM'])) ? $this->_data['.'][0]['BU_FORM'] : '') . '<button type="submit" class="mainoption" ' . ((isset($this->_data['.'][0]['BU_ONCLICK'])) ? $this->_data['.'][0]['BU_ONCLICK'] : '') . '><i class=""></i>' . ((isset($this->_data['.'][0]['BU_VALUE'])) ? $this->_data['.'][0]['BU_VALUE'] : '') . '</button>' . ((isset($this->_data['.'][0]['BU_FORM_END'])) ? $this->_data['.'][0]['BU_FORM_END'] : '') . '';// ENDIF
}
echo '
	</div>
