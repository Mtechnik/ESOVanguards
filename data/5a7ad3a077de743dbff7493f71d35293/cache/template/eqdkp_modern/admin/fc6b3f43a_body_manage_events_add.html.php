...
<div class="breadcrumb-container">
	<ul class="breamcrumb">
		...
		<li><a href="' . ((isset($this->_data['.'][0]['EQDKP_ROOT_PATH'])) ? $this->_data['.'][0]['EQDKP_ROOT_PATH'] : '') . 'admin/manage_events.php' . ((isset($this->_data['.'][0]['SID'])) ? $this->_data['.'][0]['SID'] : '') . '">' . ((isset($this->_data['.'][0]['L_manevents_title'])) ? $this->_data['.'][0]['L_manevents_title'] : (($this->lang('manevents_title')) ? $this->lang('manevents_title') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'manevents_title'))) . '         }')) . '</a></li>
		<li class="current"><a>';// IF S_UPD
if ($this->_data['.'][0]['S_UPD']) { 
echo '' . ((isset($this->_data['.'][0]['NAME'])) ? $this->_data['.'][0]['NAME'] : '') . '';// ELSE
} else {
echo '' . ((isset($this->_data['.'][0]['L_addevent_title'])) ? $this->_data['.'][0]['L_addevent_title'] : (($this->lang('addevent_title')) ? $this->lang('addevent_title') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'addevent_title'))) . '         }')) . '';// ENDIF
}
echo '</a></li>
	</ul>
	<div class="clear"></div>
...
<input type="hidden" name="calendar" value="' . ((isset($this->_data['.'][0]['CALENDAR'])) ? $this->_data['.'][0]['CALENDAR'] : '') . '" />

<fieldset class="settings">
	<legend>' . ((isset($this->_data['.'][0]['L_addevent_title'])) ? $this->_data['.'][0]['L_addevent_title'] : (($this->lang('addevent_title')) ? $this->lang('addevent_title') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'addevent_title'))) . '         }')) . '</legend>
	<dl>
		...
		<dd><input type="text" name="name" size="35" maxlength="255" value="' . ((isset($this->_data['.'][0]['NAME'])) ? $this->_data['.'][0]['NAME'] : '') . '" class="input" /></dd>
	</dl>
	';// IF not S_POINTS_DISABLED
if (! $this->_data['.'][0]['S_POINTS_DISABLED']) { 
echo '
	<dl>
		<dt><label>' . ((isset($this->_data['.'][0]['L_value'])) ? $this->_data['.'][0]['L_value'] : (($this->lang('value')) ? $this->lang('value') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'value'))) . '         }')) . ':</label></dt>
		<dd><input type="text" name="value" size="8" maxlength="7" value="' . ((isset($this->_data['.'][0]['VALUE'])) ? $this->_data['.'][0]['VALUE'] : '') . '" class="input" /></dd>
	</dl>
	';// ENDIF
}
echo '
	<dl>
		<dt><label>' . ((isset($this->_data['.'][0]['L_multidkp_to_event'])) ? $this->_data['.'][0]['L_multidkp_to_event'] : (($this->lang('multidkp_to_event')) ? $this->lang('multidkp_to_event') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'multidkp_to_event'))) . '         }')) . ':</label></dt>
		<dd>' . ((isset($this->_data['.'][0]['MDKP2EVENT'])) ? $this->_data['.'][0]['MDKP2EVENT'] : '') . '</dd>
	</dl>
	<dl>
		<dt><label>' . ((isset($this->_data['.'][0]['L_event_icon_header'])) ? $this->_data['.'][0]['L_event_icon_header'] : (($this->lang('event_icon_header')) ? $this->lang('event_icon_header') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'event_icon_header'))) . '         }')) . ':</label></dt>
		<dd><button class="mainoption" type="button" id="iubuttonedit" onclick="elfinder_all();"><i class="fa fa-upload"></i> ' . ((isset($this->_data['.'][0]['L_upload_eventicon'])) ? $this->_data['.'][0]['L_upload_eventicon'] : (($this->lang('upload_eventicon')) ? $this->lang('upload_eventicon') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'upload_eventicon'))) . '         }')) . '</button></dd>
	</dl>
	
	<table class="table fullwidth scrollable-x">
	';// IF ICONS
if ($this->_data['.'][0]['ICONS']) { 
// BEGIN files_row
$_files_row_count = (isset($this->_data['files_row.'])) ?  sizeof($this->_data['files_row.']) : 0;
if ($_files_row_count) {
...
echo '
	<tr class="colorswitch">
		';// BEGIN fields
$_fields_count = (isset($this->_data['files_row.'][$_files_row_i]['fields.'])) ? sizeof($this->_data['files_row.'][$_files_row_i]['fields.']) : 0;
if ($_fields_count) {
...
if ($this->_data['files_row.'][$_files_row_i]['fields.'][$_fields_i]['CHECKBOX']) { 
echo '
			<label><input type="radio" name="icon" ' . ((isset($this->_data['files_row.'][$_files_row_i]['fields.'][$_fields_i]['CHECKED'])) ? $this->_data['files_row.'][$_files_row_i]['fields.'][$_fields_i]['CHECKED'] : '') . ' value="' . ((isset($this->_data['files_row.'][$_files_row_i]['fields.'][$_fields_i]['NAME'])) ? $this->_data['files_row.'][$_files_row_i]['fields.'][$_fields_i]['NAME'] : '') . '" />
			' . ((isset($this->_data['files_row.'][$_files_row_i]['fields.'][$_fields_i]['IMAGE'])) ? $this->_data['files_row.'][$_files_row_i]['fields.'][$_fields_i]['IMAGE'] : '') . '</label>
			';// ENDIF
}
echo '
		</td>
...
<button class="mainoption" type="submit" name="save" id="eventSubmBtn"><i class="fa fa-check"></i>' . ((isset($this->_data['.'][0]['L_save'])) ? $this->_data['.'][0]['L_save'] : (($this->lang('save')) ? $this->lang('save') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'save'))) . '         }')) . '</button>
';// IF S_UPD
if ($this->_data['.'][0]['S_UPD']) { 
echo '
<input type="hidden" name="event_id" value="' . ((isset($this->_data['.'][0]['EVENT_ID'])) ? $this->_data['.'][0]['EVENT_ID'] : '') . '" />
<button class="mainoption" type="button" name="del" onclick="delete_warning();"><i class="fa fa-times"></i>' . ((isset($this->_data['.'][0]['L_delete'])) ? $this->_data['.'][0]['L_delete'] : (($this->lang('delete')) ? $this->lang('delete') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'delete'))) . '         }')) . '</button>
';// ENDIF
}
echo '
<button class="mainoption" type="submit" name="cancel"><i class="fa fa-chevron-left"></i>' . ((isset($this->_data['.'][0]['L_cancel'])) ? $this->_data['.'][0]['L_cancel'] : (($this->lang('cancel')) ? $this->lang('cancel') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'cancel'))) . '         }')) . '</button>
