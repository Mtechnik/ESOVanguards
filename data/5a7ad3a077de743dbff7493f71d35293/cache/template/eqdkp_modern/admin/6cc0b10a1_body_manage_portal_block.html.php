...
echo '
	...
	<ul class="breamcrumb">
		...
		<li><a href="' . ((isset($this->_data['.'][0]['EQDKP_ROOT_PATH'])) ? $this->_data['.'][0]['EQDKP_ROOT_PATH'] : '') . 'admin/manage_portal.php' . ((isset($this->_data['.'][0]['SID'])) ? $this->_data['.'][0]['SID'] : '') . '">' . ((isset($this->_data['.'][0]['L_portalmanager'])) ? $this->_data['.'][0]['L_portalmanager'] : (($this->lang('portalmanager')) ? $this->lang('portalmanager') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'portalmanager'))) . '         }')) . '</a>
		<li><a href="' . ((isset($this->_data['.'][0]['EQDKP_ROOT_PATH'])) ? $this->_data['.'][0]['EQDKP_ROOT_PATH'] : '') . 'admin/manage_portal.php' . ((isset($this->_data['.'][0]['SID'])) ? $this->_data['.'][0]['SID'] : '') . '#blocks">' . ((isset($this->_data['.'][0]['L_edit_portal_block'])) ? $this->_data['.'][0]['L_edit_portal_block'] : (($this->lang('edit_portal_block')) ? $this->lang('edit_portal_block') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'edit_portal_block'))) . '         }')) . '</a>
		<li class="current"><a>';// IF NAME == ''
if ($this->_data['.'][0]['NAME'] == '') { 
echo '' . ((isset($this->_data['.'][0]['L_add_portal_block'])) ? $this->_data['.'][0]['L_add_portal_block'] : (($this->lang('add_portal_block')) ? $this->lang('add_portal_block') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'add_portal_block'))) . '         }')) . '';// ELSE
} else {
echo '' . ((isset($this->_data['.'][0]['NAME'])) ? $this->_data['.'][0]['NAME'] : '') . '';// ENDIF
}
echo '</a></li>
	</ul>
	<div class="clear"></div>
</div>
<form method="post" action="' . ((isset($this->_data['.'][0]['ACTION'])) ? $this->_data['.'][0]['ACTION'] : '') . '" name="post" id="portal_block_form" class="fv_checkit">
	<fieldset class="settings">
		<legend>' . ((isset($this->_data['.'][0]['L_edit_portal_block'])) ? $this->_data['.'][0]['L_edit_portal_block'] : (($this->lang('edit_portal_block')) ? $this->lang('edit_portal_block') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'edit_portal_block'))) . '         }')) . '</legend>
		<dl>
			...
			<dd><input type="text" name="name" value="' . ((isset($this->_data['.'][0]['NAME'])) ? $this->_data['.'][0]['NAME'] : '') . '" class="input" required /></dd>
		</dl>
		<dl>
			<dt><label>' . ((isset($this->_data['.'][0]['L_wide_content'])) ? $this->_data['.'][0]['L_wide_content'] : (($this->lang('wide_content')) ? $this->lang('wide_content') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'wide_content'))) . '         }')) . ':</label></dt>
			<dd><input type="checkbox" name="wide_content" value="1" ' . ((isset($this->_data['.'][0]['WIDE_CONTENT_CHECKED'])) ? $this->_data['.'][0]['WIDE_CONTENT_CHECKED'] : '') . ' /></dd>
		</dl>
	</fieldset>
	<button class="mainoption" type="submit" name="save_block"><i class="fa fa-check"></i>' . ((isset($this->_data['.'][0]['L_save'])) ? $this->_data['.'][0]['L_save'] : (($this->lang('save')) ? $this->lang('save') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'save'))) . '         }')) . '</button>
	';// IF BLOCKID
if ($this->_data['.'][0]['BLOCKID']) { 
echo '
	<input type="hidden" name="b" value="' . ((isset($this->_data['.'][0]['BLOCKID'])) ? $this->_data['.'][0]['BLOCKID'] : '') . '" />
	';// ENDIF
}
echo '
	<button class="mainoption" type="button" name="cancel" onclick="window.location=\'manage_portal.php' . ((isset($this->_data['.'][0]['SID'])) ? $this->_data['.'][0]['SID'] : '') . '\'"><i class="fa fa-chevron-left"></i>' . ((isset($this->_data['.'][0]['L_cancel'])) ? $this->_data['.'][0]['L_cancel'] : (($this->lang('cancel')) ? $this->lang('cancel') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'cancel'))) . '         }')) . '</button>
