...
echo '
	...
	<ul class="breamcrumb">
		...
		<li class="current"><a>' . ((isset($this->_data['.'][0]['L_settings'])) ? $this->_data['.'][0]['L_settings'] : (($this->lang('settings')) ? $this->lang('settings') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'settings'))) . '         }')) . '</a></li>
	</ul>
	<div class="clear"></div>
</div>
<form method="post" action="' . ((isset($this->_data['.'][0]['ACTION'])) ? $this->_data['.'][0]['ACTION'] : '') . '" name="' . ((isset($this->_data['.'][0]['FORM_ID'])) ? $this->_data['.'][0]['FORM_ID'] : '') . '" id="' . ((isset($this->_data['.'][0]['FORM_ID'])) ? $this->_data['.'][0]['FORM_ID'] : '') . '">
...
echo '
				<dl>
					...
					<dd>' . ((isset($this->_data['tabs.'][$_tabs_i]['fieldsets.'][$_fieldsets_i]['fields.'][$_fields_i]['FIELD'])) ? $this->_data['tabs.'][$_tabs_i]['fieldsets.'][$_fieldsets_i]['fields.'][$_fields_i]['FIELD'] : '') . '</dd>
				</dl>
				';}}
// END fields
echo '
...
echo '
		...
		<div align=\'center\'>
			<button  name="save_plus" type="submit" class="mainoption" id="save"><i class="fa fa-check"></i>' . ((isset($this->_data['.'][0]['L_save'])) ? $this->_data['.'][0]['L_save'] : (($this->lang('save')) ? $this->lang('save') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'save'))) . '         }')) . '</button>
			<button type="button" name="reset" class="liteoption" onclick="window.location=\'manage_settings.php' . ((isset($this->_data['.'][0]['SID'])) ? $this->_data['.'][0]['SID'] : '') . '\'"><i class="fa fa-trash-o"></i>' . ((isset($this->_data['.'][0]['L_reset'])) ? $this->_data['.'][0]['L_reset'] : (($this->lang('reset')) ? $this->lang('reset') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'reset'))) . '         }')) . '</button>
		</div>
	</div>
...
<div id="dialog-change-game" title="' . ((isset($this->_data['.'][0]['L_overwrite_gamedata'])) ? $this->_data['.'][0]['L_overwrite_gamedata'] : (($this->lang('overwrite_gamedata')) ? $this->lang('overwrite_gamedata') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'overwrite_gamedata'))) . '         }')) . '" style="display:none;">
	' . ((isset($this->_data['.'][0]['L_overwrite_gamedata_info'])) ? $this->_data['.'][0]['L_overwrite_gamedata_info'] : (($this->lang('overwrite_gamedata_info')) ? $this->lang('overwrite_gamedata_info') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'overwrite_gamedata_info'))) . '         }')) . '<br /><br />
	<label><input type="radio" name="game_overwrite" value="1" checked="checked"> ' . ((isset($this->_data['.'][0]['L_overwrite_gamedata_yes'])) ? $this->_data['.'][0]['L_overwrite_gamedata_yes'] : (($this->lang('overwrite_gamedata_yes')) ? $this->lang('overwrite_gamedata_yes') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'overwrite_gamedata_yes'))) . '         }')) . '</label>
	<br /><label><input type="radio" name="game_overwrite" value="2"> ' . ((isset($this->_data['.'][0]['L_overwrite_gamedata_nobut'])) ? $this->_data['.'][0]['L_overwrite_gamedata_nobut'] : (($this->lang('overwrite_gamedata_nobut')) ? $this->lang('overwrite_gamedata_nobut') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'overwrite_gamedata_nobut'))) . '         }')) . '</label>
	<br /><label><input type="radio" name="game_overwrite" value="0"> ' . ((isset($this->_data['.'][0]['L_overwrite_gamedata_no'])) ? $this->_data['.'][0]['L_overwrite_gamedata_no'] : (($this->lang('overwrite_gamedata_no')) ? $this->lang('overwrite_gamedata_no') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'overwrite_gamedata_no'))) . '         }')) . '</label>
	<br /><br /><button type="button" id="game-overwrite-button"><i class="fa fa-check"></i> ' . ((isset($this->_data['.'][0]['L_submit'])) ? $this->_data['.'][0]['L_submit'] : (($this->lang('submit')) ? $this->lang('submit') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'submit'))) . '         }')) . '</button>
</div>
...
$(document).ready(function(){
	...
	origin_lang = "' . ((isset($this->_data['.'][0]['SET_GAME_LANG'])) ? $this->_data['.'][0]['SET_GAME_LANG'] : '') . '";
	...
	$(\'#default_game\').on(\'change\', function(){
		...
		if(new_game != origin_game) {
			game_changed = true;
			$("input[name=\'game_overwrite\'][value=\'1\']").attr("checked","checked");
	...
	$(\'#game_language\').on(\'change\', function(){
		...
		if(new_lang != origin_lang && !game_changed) {
			...
			$("input[name=\'game_overwrite\'][value=\'0\']").attr("checked","checked");
			$( "#dialog-change-game" ).dialog(\'open\');
		} else {
