...
echo '
	...
	<ul class="breamcrumb">
		...
		<li class="current"><a>' . ((isset($this->_data['.'][0]['L_manevents_title'])) ? $this->_data['.'][0]['L_manevents_title'] : (($this->lang('manevents_title')) ? $this->lang('manevents_title') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'manevents_title'))) . '         }')) . '</a></li>
	</ul>
	<div class="clear"></div>
</div>

<div class="contentHeader">
	<h1 class="contentTitle">' . ((isset($this->_data['.'][0]['L_manevents_title'])) ? $this->_data['.'][0]['L_manevents_title'] : (($this->lang('manevents_title')) ? $this->lang('manevents_title') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'manevents_title'))) . '         }')) . '</h1>
</div>
<div class="tableHeader floatRight">
		<button type="button" name="add" class="mainoption" onclick="window.location=\'manage_events.php' . ((isset($this->_data['.'][0]['SID'])) ? $this->_data['.'][0]['SID'] : '') . '&amp;upd=true\'" ><i class="fa fa-plus"></i>' . ((isset($this->_data['.'][0]['L_addevent_title'])) ? $this->_data['.'][0]['L_addevent_title'] : (($this->lang('addevent_title')) ? $this->lang('addevent_title') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'addevent_title'))) . '         }')) . '</button>
</div>
<div class="clear"></div>
...
<div class="center pagination_wrapper">
	' . ((isset($this->_data['.'][0]['EVENT_PAGINATION'])) ? $this->_data['.'][0]['EVENT_PAGINATION'] : '') . '
</div>
';// ELSE
} else {
echo '<!DOCTYPE html>
