...
echo '
	...
	<ul class="breamcrumb">
		...
		<li class="current"><a>' . ((isset($this->_data['.'][0]['L_manraid_title'])) ? $this->_data['.'][0]['L_manraid_title'] : (($this->lang('manraid_title')) ? $this->lang('manraid_title') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'manraid_title'))) . '         }')) . '</a></li>
	</ul>
	<div class="clear"></div>
</div>
<form action=\'\' method=\'post\'>
<div class="contentHeader">
	<h1 class="contentTitle">' . ((isset($this->_data['.'][0]['L_manraid_title'])) ? $this->_data['.'][0]['L_manraid_title'] : (($this->lang('manraid_title')) ? $this->lang('manraid_title') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'manraid_title'))) . '         }')) . '</h1>
</div>
<div class="tableHeader floatRight">
		' . ((isset($this->_data['.'][0]['IMPORT_DKP'])) ? $this->_data['.'][0]['IMPORT_DKP'] : '') . ' <button type="button" name="add" class="mainoption" onclick="window.location=\'manage_raids.php' . ((isset($this->_data['.'][0]['SID'])) ? $this->_data['.'][0]['SID'] : '') . '&amp;upd=true\'" ><i class="fa fa-plus"></i>' . ((isset($this->_data['.'][0]['L_add_raid'])) ? $this->_data['.'][0]['L_add_raid'] : (($this->lang('add_raid')) ? $this->lang('add_raid') : '{ ' . ucfirst(strtolower(str_replace('_', ' ', 'add_raid'))) . '         }')) . '</button>
</div>
<div class="clear"></div>
